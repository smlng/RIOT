...
#define UART1_TXD   GPIO15  /**< direct I/O pin for UART_DEV(0) TxD, can't be changed */
#define UART1_RXD   GPIO12  /**< direct I/O pin for UART_DEV(0) RxD, can't be changed */

#define UART2_TXD   GPIO17  /**< direct I/O pin for UART_DEV(0) TxD, can't be changed */
#define UART2_RXD   GPIO16  /**< direct I/O pin for UART_DEV(0) RxD, can't be changed */
/** @} */
