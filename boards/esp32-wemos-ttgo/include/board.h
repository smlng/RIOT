...
#define LED0_PIN        GPIO2   /**< LED0 is available when the camera is not plugged in */
...
/**
 * @name SX127X LoRa Config
 * @{
 */
//#define SX127X_USE_DIO_MULTI
//#define SX127X_PARAM_DIO_MULTI      GPIO26
